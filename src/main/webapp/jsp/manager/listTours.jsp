							...
							<tr>
								<td style="border: none; background: #ffffff; width: 5px">
									<form action="controller" method="get">
										<input type="hidden" name="command" value="changeHotStatus" />
										<input type="hidden" name="idT" value="${tour.id}" /> <input
											type="hidden" name="hot" value="${!tour.hot}" />
								...
								<td>
								<a
									href="${pageContext.request.contextPath}/controller?command=viewTour&idTour=${tour.id}">
